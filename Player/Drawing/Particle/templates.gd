...
var templates = [
	...
	{"name": "circle", "points": generate_circle_points(1, 32)},  # Assuming radius 1 and 32 segments
	{"name": "simple_lightning", "points": [Vector2(0, 0), Vector2(0.5, -0.707), Vector2(-0.5, -0.707), Vector2(-0, -1.4)]},
